...
const translations = {
  ...
  en: {
    ...
    straumannPeriod: 'June 2023 - June 2024',
    straumann1: 'Led backend and frontend development for a specialized application for implantologists.',
    straumann2: 'Coordinated releases and DevOps tasks, including pipeline administration.',
    straumann3: 'Designed components with React and TypeScript, focused on efficient and robust implementation.',
    straumann4: 'Created and administered microservices with Java Spring Boot, applying SOLID and hexagonal architecture.',
    straumann5: 'Maintained constant communication with stakeholders to propose new features and improvements.',
    straumannStack: 'Stack: Java, Spring Boot, React, TypeScript, SOLID, Hexagonal architecture, DevOps, Pipelines.',
